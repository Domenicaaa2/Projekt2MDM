package ch.zhaw.deeplearningjavahabegnin.playground;
...
public final class Training {
    ...
    public static void main(String[] args) throws IOException, TranslateException {
        ...
        // ImageFolder dataset = initDataset("ut-zap50k-images-square"); !!!Subset erwischen hier!!!
        ImageFolder dataset = initDataset("Bilder/root");
